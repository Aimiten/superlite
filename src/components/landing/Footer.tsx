      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between mb-10">
          <div className="md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-bold mb-4 text-white">Arvento</h3>
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-slate-400">Kirjaudu</span>
              </li>
            </ul>
          </div>

          <div className="md:w-1/3 md:text-right">
            <h3 className="text-lg font-bold mb-4 text-white">Tietoa meistä</h3>
            <p className="text-slate-400 mb-3 max-w-xs md:ml-auto">
