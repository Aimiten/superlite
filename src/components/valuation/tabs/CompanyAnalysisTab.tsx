          ...
          {(companyInfoAnalysis?.asiakasJaMarkkina || companyInfo?.structuredData?.market_position) && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="text-xs bg-green-100 text-green-800">Markkinointi</Badge>
              </div>
          ...
          {companyInfoAnalysis?.kilpailuJaErot && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="text-xs bg-purple-100 text-purple-800">Erottautumistekijät</Badge>
              </div>
          ...
          {companyInfoAnalysis?.strategiaJaTulevaisuus && (
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary" className="text-xs bg-amber-100 text-amber-800">Visio</Badge>
              </div>
          ...
          {companyInfoAnalysis?.lahteet && (
            <div className="mt-6 p-3 bg-slate-50 rounded-lg border border-slate-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-slate-600">Tietolähteet</span>
              </div>
      ...
      {!companyInfoAnalysis?.liiketoiminnanKuvaus && 
       ...
       !valuationReport?.analysis?.business_model?.content && (
        <div className="border border-slate-200 rounded-xl p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-slate-600 mb-2">Yritysanalyysi ei saatavilla</h3>
