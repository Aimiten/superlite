        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 font-medium">1</div>
              <p>Tilinpäätöksen analysointi ja normalisoiminen markkinaehtoiseksi poistamalla kertaluonteiset erät.</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 font-medium">2</div>
              <p>Tarkentavien kysymysten esittäminen tilinpäätöksen normalisoimiseksi (omistajan palkka, vuokrat, jne.)</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 font-medium">3</div>
              <p>Toimiala-analyysi ja markkinakertoimien soveltaminen yrityksen lukuihin.</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 font-medium">4</div>
              <p>Arvonmääritys usealla menetelmällä (liikevaihto-, EBITDA-, EBIT- ja P/E-kertoimet).</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 font-medium">5</div>
