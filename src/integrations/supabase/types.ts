  ...
  public: {
    Tables: {
      ...
      dcf_scenario_analyses: {
        ...
        Relationships: [
          {
            foreignKeyName: "dcf_scenario_analyses_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "dcf_scenario_analyses_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "dcf_scenario_analyses_valuation_id_fkey"
