...
// import { useCompanyTasks } from "@/hooks/use-company-tasks"; // VIRHE: Tämä hook ei ole olemassa
...
const TaskDetail = () => {
  ...
  // KORJAUS: useCompanyTasks ei ole olemassa, käytetään suoraan Supabase kutsuja
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {/* Task status section - moved inside the main content area */}
              <div className="border-t mt-6 pt-6">
                <div className="bg-slate-50 p-4 rounded-md border border-slate-200">
                  <div className="flex flex-col">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-base font-medium mb-0">Tehtävän tila</h3>
                    </div>
                    <p className="text-sm text-muted-foreground mb-3">
                      {task.completion_status === "completed" 
                        ? "Tämä tehtävä on merkitty valmiiksi." 
                        : "Merkitse tehtävä valmiiksi kun olet saanut sen toteutettua."}
                    </p>
                    <Button 
