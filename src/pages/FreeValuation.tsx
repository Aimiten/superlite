                      ...
                      <TabsContent value="privacy" className="space-y-4">
                        <div className="bg-slate-50 rounded-lg p-4 border border-slate-100">
                          ...
                          <p className="text-sm text-slate-600">
                            Tarkemmat palvelun käyttöehdot ja lisätietoa  löydät <Link to="https://www.aimiten.fi/arvento-free-ehdot" className="text-indigo-600 hover:text-indigo-800 hover:underline">täältä</Link>.
                          </p>
                        </div>
                      </TabsContent>
                    </Tabs>
